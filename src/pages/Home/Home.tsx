  ...
  return (
    <section>
          ...
          <article className='flex flex-col md:gap-20 gap-12 md:pl-8'>
            <div className='grid gap-4 md:mt-10 mt-0 xl:text-right text-left'>
              <h1 className='text-5xl'>
                Haz la <span className='text-green-2'>diferencia</span> con tu contenido
              </h1>
              <p className='text-gray-400 text-sm'>
                Lorem ipsum dolor sit amet consectetur adipisicing elit. A eaque sunt ullam, placeat
                alias eum debitis odio perspiciatis ipsam laboriosam voluptatum illum cumque nam
                recusandae vel fugit? Eos, nobis harum?
              </p>
            </div>
            <a
      ...
      <section id='plans__section' className='p-1 z-10 md:mt-10 mt-3 sm:px-10'>
        <h1 className='text-3xl text-center text-white mt-8 mb-4'>ELIGE TU WEB</h1>
      ...
      <section className='grid lg:gap-0 gap-10 lg:grid-cols-2 grid-cols-1 my-10 py-20 xl:px-44 md:px-20 sm:px-8 px-4 ease-linear duration-500'>
        <div className='flex flex-col justify-center text-white'>
          ...
          <h1 className='sm:text-5xl text-4xl ease-linear duration-300'>enfocamos</h1>
          <h1 className='sm:text-6xl text-5xl ease-linear duration-300'>en tus</h1>
